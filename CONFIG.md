...
You can get free "deadman switch" monitoring from [healthchecks.io](https://healthchecks.io/) which will alert you if HbWatcher stops checking in on a custom, private URL that you can configure on their site.  This helps close the loop on your monitoring so you'll know if your HbWatcher itself is dead.
